...
c2DRenderer::c2DRendererIndexedBuffer::c2DRendererIndexedBuffer()
{
    ...
    pVertices[0].m_pos = D3DXVECTOR3(-3.5f, -3.5f, 0.f);
    pVertices[1].m_pos = D3DXVECTOR3(-3.5f, 3.5f, 0.f);
    pVertices[2].m_pos = D3DXVECTOR3(3.5f, 3.5f, 0.f);
    pVertices[3].m_pos = D3DXVECTOR3(3.5f, -3.5f, 0.f);

    pVertices[0].m_uv = D3DXVECTOR2(4, 0);
    pVertices[1].m_uv = D3DXVECTOR2(0, 0);
    pVertices[2].m_uv = D3DXVECTOR2(0, 4);
    pVertices[3].m_uv = D3DXVECTOR2(4, 4);
